package com.technokriti.asiacellplus.helpful;
...
public class AsiacellFirebaseInstanceService extends FirebaseInstanceIdService {

    private static final String TAG="AsiacellFirebaseInstanceServi";
